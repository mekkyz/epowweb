...
export default function RolePreview() {
  ...
  return (
    <div className="fixed right-4 bottom-4 z-[9999] flex flex-col items-end gap-2">
      {!collapsed && (
        <div className="animate-in fade-in slide-in-from-bottom-2 border-border bg-panel rounded-xl border p-3 shadow-lg">
          <p className="text-foreground-tertiary mb-2 text-[10px] font-semibold tracking-widest uppercase">
            Preview as role
          </p>
          ...
          {selected !== "off" && (
            <p className="text-foreground-tertiary mt-2 text-[10px]">
